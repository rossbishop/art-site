          ...
          <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center">
                  <div className="btn-group">
                      <button type="button" className={cx(projectCardStyles.buttonView, "btn", "btn-sm", "btn-outline-secondary", projectCardStyles.btnMod)}><Link className={projectCardStyles.links} to="/loading" onClick={event => {props.setLoading(true);props.setDestinationPage(props.link)}}>View</Link></button>
                  </div>
