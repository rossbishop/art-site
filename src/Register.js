            ...
            <div className="row">
                <div className="col-12">
                    <form className={RegisterStyles.formProfileUpdate}>
                        ...
                        <select className={RegisterStyles.dateDropdown} id="month" onChange={event => props.setBirthMonth(event.target.value)}></select>
                        <select className={RegisterStyles.dateDropdown} id="day" onChange={event => props.setBirthDay(event.target.value)}></select>
                        <input type="birthyear" id="year" placeholder="Enter Year" onChange={event => {var birthYear = event.target.value; props.setBirthYear(String(birthYear).padStart(4,'0'));}}></input>
                        ...
                        <input type="password" id="inputPasswordConfirm" className={cx(RegisterStyles.formControl,"mb-3", "py-2", "pl-0")} placeholder="Confirm Password" onChange={event => props.setPasswordConfirm(event.target.value)} required autoFocus/>
                        <button className={cx(RegisterStyles.btnLogin, "btn", "btn-lg", "btn-primary", "btn-block", "mt-4")} type="submit" onClick={(e) => {e.preventDefault();props.signUp({email,username,password,passwordConfirm});}}>Register</button>
                    </form>
                </div>
            </div>
        </div>
