                    ...
                    <div className="col-md-4">
                        <div className="card mb-4 shadow-sm">
                            ...
                            <div className="card-body">
                                <p className="card-text project-description">This is a description of a project</p>
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <small className="project-info-icons">n 
                                        <img className="comms-img" src="https://systemuicons.com/images/icons/message_writing.svg"/> / n 
                                        <img className="comms-img" src="https://systemuicons.com/images/icons/write.svg"/> / n 
